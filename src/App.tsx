    ...
    <ErrorBoundary>
      <BrowserRouter>
        <Routes>
          ...
          {entities.map((entity) => (
            <Route key={entity.id} path={entity.basePath} element={<entity.ListPageComponent />} />
          ))}
          ...
          <Route
            path="/dashboard/financial-data/edit/:countryCode"
            element={<FinancialDataEditPage />}
          />
          ...
          <Route
            ...
            element={<Navigate to="/dashboard/financial-data/create" replace />}
          />
          <Route
            path="/dashboard/edit/:countryCode"
            element={<Navigate to="/dashboard/financial-data/edit/:countryCode" replace />}
          />
          <Route
            path="/dashboard/summary"
            element={<Navigate to="/dashboard/financial-data/summary" replace />}
          />
